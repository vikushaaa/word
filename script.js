console.clear();let arr = [
    "в якому місті населення 244 тис","найбезпечніша країна","хто написав щедрик","хто придумав ядерну зброю","Скільки голосних букв в країнському алфавіті",  "В якому місті України найбільше жителів",
    "частина мови яка відповідає на питання що і хто",  "Хто придумав комп'ютер",
    "Яка область в Україні найменша за площею"];
  let arr2 = ["рівне","ісландія","леонтович","оппенгеймер","шість", "київ", "іменник", "беббідж", "чернівецька"];
